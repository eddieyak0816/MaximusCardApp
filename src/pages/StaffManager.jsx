...
function Customers() {
  ...
  const [linkedCards, setLinkedCards] = useState([]); // <--- Stores cards for the selected customer
  ...
  // 2. Fetch Cards for specific customer (Triggered when Edit is clicked)
        ...
        <div style={{background:'#f0f0f0', color:'black', padding:'20px', borderRadius:'8px', marginBottom:'20px', border:'2px solid #007bff'}}>
          ...
          <div style={{marginTop:'20px', borderTop:'1px solid #ccc', paddingTop:'10px'}}>
             ...
             {linkedCards.length === 0 ? (
                 <p style={{fontStyle:'italic', color:'#666'}}>No cards linked to this customer.</p>
             ) : (
